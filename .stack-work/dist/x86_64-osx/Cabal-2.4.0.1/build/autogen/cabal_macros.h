...
/* package hlint-source-plugin-0.1.0.0 */
#ifndef VERSION_hlint_source_plugin
#define VERSION_hlint_source_plugin "0.1.0.0"
#endif /* VERSION_hlint_source_plugin */
#ifndef MIN_VERSION_hlint_source_plugin
#define MIN_VERSION_hlint_source_plugin(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_hlint_source_plugin */
...
#define CURRENT_PACKAGE_KEY "project-0.0.0-FO2Gzjbt7Lk4PyYkO8OLel"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "project-0.0.0-FO2Gzjbt7Lk4PyYkO8OLel"
